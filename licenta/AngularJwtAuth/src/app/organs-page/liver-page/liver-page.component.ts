...
@Component({
  selector: 'app-liver-page',
  templateUrl: './liver-page.component.html',
  styleUrls: ['./liver-page.component.css']
})
export class LiverPageComponent implements OnInit {
  ...
  ngOnInit() {
    this.httpClientService.getAllLiverInformation().subscribe(
