...
@Component({
  selector: 'app-large-intestines-page',
  templateUrl: './large-intestines-page.component.html',
  styleUrls: ['./large-intestines-page.component.css']
})
export class LargeIntestinesPageComponent implements OnInit {

  largeIntestines: LargeIntestines[];
  ...
  ngOnInit() {
    this.httpClientService.getAllLargeIntestinesInformation().subscribe(
