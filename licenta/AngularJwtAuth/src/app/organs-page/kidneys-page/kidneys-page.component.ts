...
@Component({
  selector: 'app-kidneys-page',
  templateUrl: './kidneys-page.component.html',
  styleUrls: ['./kidneys-page.component.css']
})
export class KidneysPageComponent implements OnInit {
  ...
  ngOnInit() {
    this.httpClientService.getAllKidneysInformation().subscribe(
